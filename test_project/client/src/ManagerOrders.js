...
/**
 * @author Joanne Liu
 * Component for manager order screen.
 */
class ManagerOrders extends Component {

    /**
     * Constructs a new instance of the manager order screen component.
     * 
    ...
    */
    ...
    /**
     * Renders the manager order screen component.
     * @returns {JSX.Element} The JSX element representing the manager order screen.
     */
    render() {
