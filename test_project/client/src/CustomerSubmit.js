...
/**
 * @author Joanne Liu
 * Component for customer order submission on customer self-order view.
 */
class CustomerSubmit extends Component {


    /**
    * Constructs a new customer submit screen component.
    * 
    ...
    */
    ...
    renderSelectedItems() {
        ...
        return (
            <div>
                {submitted && (
                    <Navigate to="/CustomerOrders" replace={true} />
                )}
                {/* <h2>Order</h2> */}
     ...
     */
    render() {
        const { isConfirmationOpen, total, errorQuantity} = this.state;
