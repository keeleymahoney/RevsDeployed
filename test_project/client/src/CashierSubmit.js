...
/**
 * @author Joanne Liu
 * Component for customer order submission on cashier view.
 */
class CashierSubmit extends Component {


    /**
    * Constructs a new cashier submit screen component.
    * 
    ...
    */
    ...
    renderSelectedItems() {
        ...
        console.log("render selected: ", selectedItems);
        return (
            <div>
                {submitted && (
                    <Navigate to="/CashierOrders" replace={true} />
                )}
                {/* <h2>Order</h2> */}
